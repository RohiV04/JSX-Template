          ...
          <main className="mb-auto col-12">
            ...
            <form className="row">
              <div className="col-12">
                ...
                <button type="submit" className="btn btn-dark btn-xl mb-4">
                  Submit
                </button>
              </div>
            </form>
        ...
        <div className="col-12 col-md-5 col-lg-6 col-xl-7 ">
          <div className="mb-auto col-12 ">
            ...
            >
              ...
              <h3 className="fw-bold">Eluru , AP , India</h3>
              <hr className="w-100" />
              <p className="mb-2">Call me:</p>
              <h3 className="fw-bold">7671050055</h3>
              <hr className="w-100" />
              <p className="mb-2">Mail me:</p>
              <h3 className="fw-bold">rohithvanagapandu007@gmail.com</h3>
              <hr className="w-100" />
              ...
              <div className="d-flex pt-2">
                ...
                <a className="btn btn-square btn-primary me-2" href="https://github.com/">
                ...
                <a className="btn btn-square btn-primary me-2" href="https://www.linkedin.com/feed/">
